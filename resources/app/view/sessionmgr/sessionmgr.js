(function () {
	...
	// constants
	var dataReq = 'StarfaceSessionDataRequest',
		dataResp = 'StarfaceSessionDataResponse';
    // constants
    var refreshInterval = 2000;
	var refreshPromise=null;
	angular.module('ovStarfaceserversession', [])
		.controller('OvStarfaceserversessionCtrl', 
		...
		function (_$log_, _$interval_, _$timeout_, _$scope_, _wss_, _ks_) { 
			...
			$scope.$on('$destroy', function () {
				...
				stopRefresh();
				$log.log('OvStarfaceserversessionCtrl has been destroyed');
			});
