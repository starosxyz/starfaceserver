...
(function () {
	...
	// constants
	var dataReq = 'StarfaceChannelDataRequest',
		dataResp = 'StarfaceChannelDataResponse';
    // constants
    var refreshInterval = 2000;
	var refreshPromise=null;
	angular.module('ovStarfaceserverchannel', [])
		.controller('OvStarfaceserverchannelCtrl', 
		...
		function (_$log_, _$interval_, _$timeout_, _$scope_, _wss_, _ks_) { 
			...
			$scope.$on('$destroy', function () {
				...
				stopRefresh();
				$log.log('OvStarfaceserverchannelCtrl has been destroyed');
			});
